  ...
  return (
    <div className="p-8 md:p-12 animate-fade-in-up">
      ...
      <VideoSection
        ...
        videoUrl="https://www.youtube.com/embed/dQw4w9WgXcQ" // Replace with actual farmer app demo link
      />

      {/* Officer Dashboard Prototype */}
      <VideoSection
        title="Kisan Adhikari – Officer Dashboard Prototype"
        ...
        videoUrl="https://www.youtube.com/embed/dQw4w9WgXcQ" // Replace with actual officer dashboard demo link
      />
    </div>
  );
};
